...
from traders.models import ArbitrageTrader, Trader, TraderOrder, TraderPosition
...
def traders_process_for_exchange_client(
    ...
    traders: List[Trader] = Trader.objects.select_related(
        ...
        "risk_manager",
        "candle_provider",
        "candle_provider__first_source",
        "candle_provider__first_source__trading_pair",
        "candle_provider__first_source__exchange_client",
        "candle_provider__first_source__exchange_client__exchange",
