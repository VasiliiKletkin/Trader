...
class TestPositionSizeAllInMixin:
    ...
    def test_calculate_position_size(self):
        ...
        size = mixin.calculate_position_size(
            PositionType.LONG, price, balance, candles=[]
        )
        # AllIn: balance / price = 1000 / 100 = 10
        assert size == Decimal("10.0")

    def test_calculate_position_size_with_decimal_price(self):
    ...
    def test_calculate_position_size_short(self):
        ...
        size = mixin.calculate_position_size(
            PositionType.SHORT, price, balance, candles=[]
        )
...
class TestPositionSizeByRiskMixin:
    ...
    def test_calculate_position_size_larger_risk(self):
...
class TestPositionSizeLimitMixin:
    ...
    def test_limits_oversized_position(self):
    ...
    def test_no_limit_needed_with_risk(self):
    ...
    def test_limit_with_short_position(self):
