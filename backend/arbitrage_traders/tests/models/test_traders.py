...
class TestArbitrageTraderWinRate:
    ...
    def test_win_rate_all_winning(self, arbitrage_trader):
        ...
        ArbitrageTraderPosition.objects.create(
            ...
            left_open_cost=Decimal("100") * Decimal("1.0"),
            left_close_cost=Decimal("110") * Decimal("1.0"),
            right_open_cost=Decimal("105") * Decimal("1.0"),
            right_close_cost=Decimal("95") * Decimal("1.0"),
    ...
    def test_win_rate_all_losing(self, arbitrage_trader):
        ...
        ArbitrageTraderPosition.objects.create(
            ...
            right_open_amount=Decimal("1.0"),
            right_close_amount=Decimal("1.0"),
            left_open_cost=Decimal("110") * Decimal("1.0"),
            left_close_cost=Decimal("100") * Decimal("1.0"),
            right_open_cost=Decimal("95") * Decimal("1.0"),
            right_close_cost=Decimal("105") * Decimal("1.0"),
            opened_at=now - timedelta(hours=2),
            closed_at=now,
            left_total_fee=Decimal("0.5"),
            right_total_fee=Decimal("0.5"),
    ...
    def test_win_rate_mixed(self, arbitrage_trader):
        ...
        ArbitrageTraderPosition.objects.create(
            ...
            right_close_amount=Decimal("1.0"),
            left_open_cost=Decimal("100") * Decimal("1.0"),
            left_close_cost=Decimal("120") * Decimal("1.0"),
            right_open_cost=Decimal("105") * Decimal("1.0"),
            right_close_cost=Decimal("95") * Decimal("1.0"),
        ...
        ArbitrageTraderPosition.objects.create(
            ...
            right_open_amount=Decimal("1.0"),
            right_close_amount=Decimal("1.0"),
            left_open_cost=Decimal("120") * Decimal("1.0"),
            left_close_cost=Decimal("100") * Decimal("1.0"),
            right_open_cost=Decimal("95") * Decimal("1.0"),
            right_close_cost=Decimal("105") * Decimal("1.0"),
            opened_at=now - timedelta(hours=2),
...
class TestArbitrageTraderAvgCandlesPerPosition:
    ...
    def test_single_position(self, arbitrage_trader):
        ...
        ArbitrageTraderPosition.objects.create(
            ...
            right_close_price=Decimal("95"),
            left_open_amount=Decimal("0.1"),
            left_close_amount=Decimal("0.1"),
            right_open_amount=Decimal("0.1"),
            right_close_amount=Decimal("0.1"),
            left_open_cost=Decimal("100") * Decimal("0.1"),
            left_close_cost=Decimal("110") * Decimal("0.1"),
            right_open_cost=Decimal("105") * Decimal("0.1"),
            right_close_cost=Decimal("95") * Decimal("0.1"),
    ...
    def test_multiple_positions_average(self, arbitrage_trader):
        ...
        ArbitrageTraderPosition.objects.create(
            ...
            left_close_amount=Decimal("0.2"),
            right_open_amount=Decimal("0.2"),
            right_close_amount=Decimal("0.2"),
            left_open_cost=Decimal("100") * Decimal("0.2"),
            left_close_cost=Decimal("110") * Decimal("0.2"),
            right_open_cost=Decimal("105") * Decimal("0.2"),
            right_close_cost=Decimal("95") * Decimal("0.2"),
...
class TestArbitrageTraderSyncPositionsUpsert:
    ...
    def test_upsert_updates_existing_position(self, arbitrage_trader):
        ...
        ArbitrageTraderPosition.objects.create(
            ...
            left_open_amount=Decimal("0.1"),
            right_open_amount=Decimal("0.1"),
            left_open_cost=Decimal("50000") * Decimal("0.1"),
            right_open_cost=Decimal("50100") * Decimal("0.1"),
            opened_at=now,
            left_total_fee=Decimal("0.05"),
            right_total_fee=Decimal("0.05"),
        )
    ...
    def test_load_positions_ordered_by_opened_at(self, arbitrage_trader):
        ...
        for i in [2, 0, 1]:
            ArbitrageTraderPosition.objects.create(
                ...
                right_open_amount=Decimal(str(0.1 + i * 0.01)),
                left_open_cost=Decimal("50000") * Decimal(str(0.1 + i * 0.01)),
                right_open_cost=Decimal("50100") * Decimal(str(0.1 + i * 0.01)),
    ...
    def test_pnl_r2_linear_growth(self, arbitrage_trader):
        ...
        for i in range(5):
            ArbitrageTraderPosition.objects.create(
                ...
                right_open_amount=Decimal("1.0"),
                right_close_amount=Decimal("1.0"),
                left_open_cost=Decimal("50000") * Decimal("1.0"),
                left_close_cost=Decimal("50100") * Decimal("1.0"),
                right_open_cost=Decimal("50100") * Decimal("1.0"),
                right_close_cost=Decimal("50000") * Decimal("1.0"),
    ...
    def test_pnl_r2_constant_pnl_zero_ss_tot(self, arbitrage_trader):
        ...
        for i in range(2):
            ArbitrageTraderPosition.objects.create(
                ...
                right_close_amount=Decimal("1.0"),
                left_open_cost=Decimal("50000") * Decimal("1.0"),
                left_close_cost=Decimal("50000") * Decimal("1.0"),
                right_open_cost=Decimal("50000") * Decimal("1.0"),
                right_close_cost=Decimal("50000") * Decimal("1.0"),
    ...
    def test_pnl_r2_mixed_pnl(self, arbitrage_trader):
        ...
        for i, (left_close, right_close) in enumerate(pnl_values):
            ArbitrageTraderPosition.objects.create(
                ...
                right_close_amount=Decimal("1.0"),
                left_open_cost=Decimal("50000") * Decimal("1.0"),
                left_close_cost=left_close * Decimal("1.0"),
                right_open_cost=Decimal("50000") * Decimal("1.0"),
                right_close_cost=right_close * Decimal("1.0"),
                opened_at=now - timedelta(hours=10 - i),
                closed_at=now - timedelta(hours=9 - i),
