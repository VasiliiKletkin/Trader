...
def arbitrage_position(arbitrage_trader: ArbitrageTrader) -> ArbitrageTraderPosition:
    ...
    return ArbitrageTraderPosition.objects.create(
        ...
        left_open_cost=Decimal("50000.00") * Decimal("0.1"),
        right_open_cost=Decimal("50100.00") * Decimal("0.1"),
        opened_at=now,
...
def closed_arbitrage_position(
    ...
    return ArbitrageTraderPosition.objects.create(
        ...
        left_close_cost=Decimal("5050.00"),
        right_open_cost=Decimal("5010.00"),
        right_close_cost=Decimal("4980.00"),
