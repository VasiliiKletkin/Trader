...
class TestArbitrageTradersDailyReport:
    ...
    def test_daily_report_with_closed_positions(self, arbitrage_trader, trading_pair):
        ...
        position = ArbitrageTraderPosition.objects.create(
            ...
            left_open_cost=Decimal("5000"),
            left_close_cost=Decimal("5050"),
            right_open_cost=Decimal("5010"),
            right_close_cost=Decimal("4980"),
    ...
    def test_daily_report_excludes_old_positions(self, arbitrage_trader, trading_pair):
        ...
        old_position = ArbitrageTraderPosition.objects.create(
            ...
            left_close_amount=Decimal("1"),
            right_open_amount=Decimal("1"),
            right_close_amount=Decimal("1"),
            left_open_cost=Decimal("50000"),
            left_close_cost=Decimal("51000"),
            right_open_cost=Decimal("50100"),
            right_close_cost=Decimal("49000"),
