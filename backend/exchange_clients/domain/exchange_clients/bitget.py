...
from exchanges.domain import BitgetExchange, Candle, Timeframe, TradingPair
...
if __name__ == "__main__":
    ...
    async def main():
        exchange = BitgetExchange(name="Bitget")
        client = BitgetExchangeClient(exchange=exchange, demo=False)
        tp_btc = TradingPair(
            name="BTC/USDT",
