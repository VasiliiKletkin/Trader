...
from exchanges.domain import Candle, KrakenExchange, Timeframe, TradingPair
...
if __name__ == "__main__":
    ...
    async def main():
        exchange = KrakenExchange(name="Kraken")
        client = KrakenExchangeClient(exchange=exchange, demo=False)
        tp_btc = TradingPair(
            name="BTC/USDT",
