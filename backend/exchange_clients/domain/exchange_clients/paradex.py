...
from exchanges.domain import Candle, ParadexExchange, Timeframe, TradingPair
...
class ParadexExchangeClient(AbstractExchangeClient):
    """Клиент для Paradex."""
    ...
    async def __aenter__(self) -> "ParadexExchangeClient":
...
if __name__ == "__main__":
    ...
    async def main():
        exchange = ParadexExchange(name="Paradex")
        client = ParadexExchangeClient(exchange=exchange, demo=False)
        tp_btc = TradingPair(
            name="BTC/USDT",
