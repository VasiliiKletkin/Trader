...
from exchanges.domain import Candle, GateIOExchange, Timeframe, TradingPair
...
if __name__ == "__main__":
    ...
    async def main():
        exchange = GateIOExchange(name="GateIO")
        client = GateIOExchangeClient(exchange=exchange, demo=False)
        tp_btc = TradingPair(
            name="BTC/USDT",
