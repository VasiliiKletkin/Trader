...
from exchanges.domain import BitMEXExchange, Candle, Timeframe, TradingPair
...
if __name__ == "__main__":
    ...
    async def main():
        exchange = BitMEXExchange(name="BitMEX")
        client = BitMEXExchangeClient(exchange=exchange, demo=False)
        tp_btc = TradingPair(
            name="BTC/USDT",
