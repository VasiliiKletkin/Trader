...
from exchanges.domain import Candle, CoinExExchange, Timeframe, TradingPair
...
class CoinExExchangeClient(AbstractExchangeClient):
    """Клиент для CoinEx."""
...
if __name__ == "__main__":
    ...
    async def main():
        exchange = CoinExExchange(name="CoinEx")
        client = CoinExExchangeClient(exchange=exchange)
        tp_btc = TradingPair(
            name="BTC/USDT",
